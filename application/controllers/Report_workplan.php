...
class Report_workplan extends Admin_Controller
{
	...
	$REP0WD = $this->model_report->getReportWorkPland($id);
	// This shows the tasks for the major deliverable
	$REP0WT = $this->model_report->getReportWorkPlant($id);
	// This shows the notes for the major deliverable
	$REP0WN = $this->model_report->getReportWorkPlann($id);	
	...
	// 3 foreach are used as:
		...
		//3. Previous join method is not ideal as previously task and work notes appeared side by
