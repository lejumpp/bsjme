    ...
    <div class="row">
      <div class="col-md-12 col-xs-12">
        ...
        <div class="tab-content">
                  ...
                  <div class="row">
                    ...
                    <div class="col-md-2 col-xs-2">
                      <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="trn" name="trn" autocomplete="off" value="<?php echo set_value('trn', isset($client_data['trn']) ? $client_data['trn'] : ''); ?>" />
                    ...
                    <div class="col-md-4 col-xs-4">
                      <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="company_name" name="company_name" autocomplete="off" value="<?php echo set_value('company_name', isset($client_data['company_name']) ? $client_data['company_name'] : ''); ?>" />
                      </div>
                    </div>
                    ...
                    <div class="col-md-4 col-xs-4">
                      <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="client_name" name="client_name" autocomplete="off" value="<?php echo set_value('client_name', isset($client_data['client_name']) ? $client_data['client_name'] : ''); ?>" />
                      </div>
                    </div>
                      ...
                      <div class="form-group">
                        ...
                        <select class="form-control select_group" id="activity" name="activity">
                          <?php foreach ($activity as $k => $v) : ?>
                            <option value="<?php echo $v['id'] ?>" <?php if (set_value('activity', isset($client_data['activity_id']) ? $client_data['activity_id'] : '') == $v['id']) {
                  ...
                  <div class="row">
                    ...
                    <div class="col-md-10 col-xs-10">
                      <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="address" name="address" value="<?php echo set_value('address', isset($client_data['address']) ? $client_data['address'] : ''); ?>" autocomplete="off" />
                      </div>
                    </div>
                    <div class="col-md-2 col-xs-2">
                      <div class="form-group">
                  ...
                  <div class="row">
                      ...
                      <div class="form-group">
                        ...
                        <select class="form-control select_group" id="county" name="county">
                          ...
                          <?php foreach ($county as $k => $v) : ?>
                            <option value="<?php echo $v['id'] ?>" <?php if (set_value('county', isset($client_data['county_id']) ? $client_data['county_id'] : '') == $v['id']) {
                                                                      echo "selected='selected'";
                                                                    } ?>><?php echo $v['name'] ?></option>
                          <?php endforeach ?>
                        </select>
                      ...
                      <div class="form-group">
                        ...
                        <select class="form-control select_group" id="parish" name="parish">
                          ...
                          <?php foreach ($parish as $k => $v) : ?>
                            <option value="<?php echo $v['id'] ?>" <?php if (set_value('parish', isset($client_data['parish_id']) ? $client_data['parish_id'] : '') == $v['id']) {
                                                                      echo "selected='selected'";
                                                                    } ?>><?php echo $v['name'] ?></option>
                          <?php endforeach ?>
                        </select>
                      ...
                      <div class="form-group">
                        ...
                        <select class="form-control select_group" id="city" name="city">
                          ...
                          <?php foreach ($city as $k => $v) : ?>
                            <option value="<?php echo $v['id'] ?>" <?php if (set_value('city', isset($client_data['city_id']) ? $client_data['city_id'] : '') == $v['id']) {
                                                                      echo "selected='selected'";
                                                                    } ?>><?php echo $v['name'] ?></option>
                          <?php endforeach ?>
                        </select>
                    ...
                    <div class="col-md-3 col-xs-3">
                      <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="district" name="district" autocomplete="off" value="<?php echo set_value('district', isset($client_data['district']) ? $client_data['district'] : ''); ?>" />
                      </div>
                    </div>
                  ...
                  <div class="row">
                    ...
                    <div class="col-md-3 col-xs-3">
                      <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="postal_box" name="postal_box" autocomplete="off" value="<?php echo set_value('postal_box', isset($client_data['postal_box']) ? $client_data['postal_box'] : ''); ?>" />
                      </div>
                    </div>
                    ...
                    <div class="col-md-3 col-xs-3">
                      <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="postal_code" name="postal_code" autocomplete="off" value="<?php echo set_value('postal_code', isset($client_data['postal_code']) ? $client_data['postal_code'] : ''); ?>" />
                      </div>
                    </div>
                    ...
                    <div class="col-md-3 col-xs-3">
                      <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="email" name="email" autocomplete="off" value="<?php echo set_value('email', isset($client_data['email']) ? $client_data['email'] : ''); ?>" />
                      </div>
                    </div>
                    <div class="col-md-3 col-xs-3">
                      <div class="form-group">
                        <label for="website">Website</label>
                        <input type="text" class="form-control" id="website" name="website" autocomplete="off" value="<?php echo set_value('website', isset($client_data['website']) ? $client_data['website'] : ''); ?>" />
                      </div>
                    </div>
                  </div>
                  ...
                  <div class="row">
                    ...
                    <div class="col-md-3 col-xs-3">
                      <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="contact_name" name="contact_name" autocomplete="off" value="<?php echo set_value('contact_name', isset($client_data['contact_name']) ? $client_data['contact_name'] : ''); ?>" />
                      </div>
                    </div>
                    ...
                    <div class="col-md-3 col-xs-3">
                      <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="phone" name="phone" autocomplete="off" value="<?php echo set_value('phone', isset($client_data['phone']) ? $client_data['phone'] : ''); ?>" />
                      </div>
                    </div>
                    ...
                    <div class="col-md-3 col-xs-3">
                      <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="mobile" name="mobile" autocomplete="off" value="<?php echo set_value('mobile', isset($client_data['mobile']) ? $client_data['mobile'] : ''); ?>" />
                      </div>
                    </div>
                    ...
                    <div class="col-md-3 col-xs-3">
                      <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="director_name" name="director_name" autocomplete="off" value="<?php echo set_value('director_name', isset($client_data['director_name']) ? $client_data['director_name'] : ''); ?>" />
                      </div>
                    </div>
                  ...
                  <div class="row">
                    <div class="col-md-6 col-xs-6">
                      ...
                      <?php if (in_array('updateConsultation', $user_permission)) : ?>
                        <!-- you must have the permission to update with the Save button -->
              ...
              <div class="col-md-12 col-xs-12">
                <div class="box">
                  <div class="box-body">
                    ...
                    <table id="manageTableTechnicalAdvice" class="table table-bordered table-striped" style="width:100%">
                      <thead>
                        <tr>
                          <th>Company Name</th>
                          <th>Consultant</th>
          ...
          <!-- Delete Technical Advice -->

          <?php if (in_array('deleteTechnicalAdvice', $user_permission)) : ?>

            <div class="modal fade" tabindex="-1" role="dialog" id="removeTechnicalAdviceModal">
              <div class="modal-dialog" role="document">
                <div class="modal-content">
                  <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                  ...
                  <form role="form" action="<?php echo base_url('technical_advice/remove') ?>" method="post" id="removeFormTechnicalAdvice">
                    <div class="modal-body">
