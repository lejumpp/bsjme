        ...
        <div class="row">
          <div class="col-md-4 col-xs-4 form-inline clearfix">
            <?php if (in_array('createTechnicalAdvice', $user_permission)) : ?>
              <a href="<?php echo base_url('technical_advice/create') ?>" class="btn btn-primary">Add Program</a>
            <?php endif; ?>
          </div>
      ...
      <div class="modal-content">
        ...
        <form role="form" action="<?php echo base_url('technical_advice/remove') ?>" method="post" id="removeForm">
          <div class="modal-body">
            ...
            <p>
              <font color="red">It will not be possible to recover the needs assessment, work plan and cost plan.</font>
            </p>
