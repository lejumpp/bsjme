                  ...
                  <div class="form-group">
                    ...
                    <select class="form-control select_group" id="client_holder" name="client_holder" <?php if ($fromClient != null) echo 'disabled=disabled'; ?>>
                      ...
                      <?php foreach ($client as $k => $v) : ?>
                        <option value="<?php echo $v['id'] ?>" <?php if (set_value('client', isset($fromClient) ? $fromClient : '') == $v['id']) {
                  ...
                  <div class="form-group">
                    ...
                    <select class="form-control select_group" id="program" name="program">
                      ...
                      <?php foreach ($program as $k => $v) : ?>
                        <option value="<?php echo $v['id'] ?>" <?php echo set_select('program', $v['id']); ?>><?php echo $v['name'] ?></option>
                      <?php endforeach ?>
                    </select>
                  </div>
                </div>
              ...
              <div class="row">
                ...
                <div class="col-md-2 col-xs-2">
                  <div class="form-group">
                    ...
                    <input type="date" class="form-control" id="date_created" name="date_created" autocomplete="off" readonly value="<?php echo date('Y-m-d'); ?>">
                  </div>
                </div>
