<div class="content-wrapper">
  ...
  <section class="content-header">
    ...
    <ol class="breadcrumb">
      ...
      <li><img width="25" height="25" data-toggle="tooltip" data-placement="bottom" title="Some information about the tehnical advice." src="<?php echo base_url('assets/images/question.png'); ?>" /></li>
    </ol>
  </section>
                  ...
                  <div class="row">
                    <div class="col-md-2 col-xs-2">
                      ...
                      <div class="row">
                        <div class="col-md-12 col-xs-12">
                          Last update
                          <!--<?php echo $technical_advice_data['updated_date']; ?>--> by <?php echo $technical_advice_data['updated_by']; ?>
                        </div>
                      </div> <!-- /end row submit -->
                              ...
                              <div class="form-group">
                                ...
                                <select class="form-control select_group" id="client" name="client">
                                  ...
                                  <?php foreach ($client as $k => $v) : ?>
                                    <option value="<?php echo $v['id'] ?>" <?php if (set_value('client', isset($technical_advice_data['client_id']) ? $technical_advice_data['client_id'] : '') == $v['id']) {
                          ...
                          <div class="row">
                              ...
                              <div class="form-group">
                                ...
                                <select class="form-control select_group" id="activity" name="activity">
                                  <?php foreach ($activity as $k => $v) : ?>
                                    <option value="<?php echo $v['id'] ?>" <?php if (set_value('activity', isset($technical_advice_data['activity']) ? $technical_advice_data['activity'] : '') == $v['id']) {
                                                                              echo "selected='selected'";
                                                                            } ?>><?php echo $v['name'] ?></option>
                                  <?php endforeach ?>
                                </select>
                            ...
                            <div class="col-md-3 col-xs-3">
                              <div class="form-group">
                                ...
                                <input type="date" class="form-control" id="date_created" name="date_created" autocomplete="off" value="<?php echo set_value('date_created', isset($technical_advice_data['date_created']) ? $technical_advice_data['date_created'] : ''); ?>" readonly>
                              </div>
                            </div>
                            ...
                            <div class="col-md-3 col-xs-3">
                              <div class="form-group">
                                ...
                                <input type="date" class="form-control" id="date_begin" name="date_begin" autocomplete="off" value="<?php echo set_value('date_begin', isset($technical_advice_data['date_begin']) ? $technical_advice_data['date_begin'] : ''); ?>">
                              </div>
                            </div>
                            ...
                            <div class="col-md-3 col-xs-3">
                              <div class="form-group">
                                ...
                                <input type="date" class="form-control" id="date_end" name="date_end" autocomplete="off" value="<?php echo set_value('date_end', isset($technical_advice_data['date_ended']) ? $technical_advice_data['date_ended'] : ''); ?>">
                              </div>
                            </div>
