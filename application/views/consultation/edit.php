                      ...
                      <div class="col-md-10 col-xs-10">
                        ...
                        <div class="box box-solid box-default">
                            ...
                            <div class="row">
                                ...
                                <div class="form-group">
                                  ...
                                  <select class="form-control select_group" id="client" name="client">
                                    ...
                                    <?php foreach ($client as $k => $v) : ?>
                                      <option value="<?php echo $v['id'] ?>" <?php if (set_value('client', isset($consultation_data['client_id']) ? $consultation_data['client_id'] : '') == $v['id']) {
                              ...
                              <div class="col-md-3 col-xs-3">
                                <div class="form-group">
                                  ...
                                  <input type="date" class="form-control" id="date_begin" name="date_begin" autocomplete="off" value="<?php echo set_value('date_begin', isset($consultation_data['date_begin']) ? $consultation_data['date_begin'] : ''); ?>">
                                </div>
                              </div>
                              ...
                              <div class="col-md-3 col-xs-3">
                                <div class="form-group">
                                  ...
                                  <input type="date" class="form-control" id="date_end" name="date_end" autocomplete="off" value="<?php echo set_value('date_end', isset($consultation_data['date_end']) ? $consultation_data['date_end'] : ''); ?>">
                                </div>
                              </div>
                            ...
                            <div class="row">
                              ...
                              <div class="col-md-2 col-xs-2">
                                <div class="form-group">
                                  ...
                                  <input type="text" class="form-control" id="consultation_no" name="consultation_no" autocomplete="off" value="<?php echo set_value('consultation_no', isset($consultation_data['consultation_no']) ? $consultation_data['consultation_no'] : ''); ?>">
                                </div>
                              </div>
                              ...
                              <div class="col-md-6 col-xs-6">
                                <div class="form-group">
                                  ...
                                  <input type="text" class="form-control" id="description" name="description" autocomplete="off" value="<?php echo set_value('description', isset($consultation_data['description']) ? $consultation_data['description'] : ''); ?>" />
                                </div>
                              </div>
                                ...
                                <div class="form-group">
                                  ...
                                  <select class="form-control select_group" id="consultant" name="consultant[]" multiple="multiple">
                                    ...
                                    <?php foreach ($consultant as $k => $v) : ?>
                                      <option value="<?php echo $v['id'] ?>" <?php if ($consultant_data === Null) {
                                                                              } else {
                                                                                if (in_array($v['id'], $consultant_data)) {
                                                                                  echo 'selected="selected"';
                                                                                }
                                ...
                                <div class="form-group">
                                  ...
                                  <select class="form-control select_group" id="program" name="program">
                                    ...
                                    foreach ($program as $row) {
                                      ...
                                      if (set_value('program', isset($consultation_data['program_id']) ? $consultation_data['program_id'] : '') == $row->id) {
                                        echo 'selected="selected"';
                                      };
                                      echo '>' . $row->name;
                                      '</option>';
                                ...
                                <div class="form-group">
                                  ...
                                  <select class="form-control select_group" id="phase" name="phase">
                                    ...
                                    <?php foreach ($phase as $k => $v) : ?>
                                      <option value="<?php echo $v['id'] ?>" <?php if (set_value('phase', isset($consultation_data['phase_id']) ? $consultation_data['phase_id'] : '') == $v['id']) {
                                                                                echo "selected='selected'";
                                                                              } ?>><?php echo $v['name'] ?></option>
                                    <?php endforeach ?>
                                  </select>
                                ...
                                <div class="form-group">
                                  ...
                                  <select class="form-control select_group" id="status" name="status">
                                    ...
                                    <?php foreach ($status as $k => $v) : ?>
                                      <option value="<?php echo $v['id'] ?>" <?php if (set_value('status', isset($consultation_data['status_id']) ? $consultation_data['status_id'] : '') == $v['id']) {
                                                                                echo "selected='selected'";
                                                                              } ?>><?php echo $v['name'] ?></option>
                                    <?php endforeach ?>
                                  </select>
                                ...
                                <div class="form-group">
                                  ...
                                  <select class="form-control select_group" id="standard" name="standard">
                                    ...
                                    foreach ($standard as $row) {
                                      echo '<option value="' . $row->id . '"';
                                      if (set_value('standard', isset($consultation_data['standard_id']) ? $consultation_data['standard_id'] : '') == $row->id) {
                                        echo 'selected="selected"';
                                      };
                                      echo '>' . $row->name;
                                      '</option>';
                                ...
                                <div class="form-group">
                                  ...
                                  <select class="form-control select_group" id="clause" name="clause">
                                    ...
                                    <?php foreach ($clause as $k => $v) : ?>
                                      <option value="<?php echo $v['id'] ?>" <?php if (set_value('clause', isset($consultation_data['clause_id']) ? $consultation_data['clause_id'] : '') == $v['id']) {
                                                                                echo "selected='selected'";
                                                                              } ?>><?php echo $v['name'] ?></option>
                                    <?php endforeach ?>
                                  </select>
                                ...
                                <div class="form-group">
                                  ...
                                  <select class="form-control select_group" id="sector" name="sector">
                                    ...
                                    <?php foreach ($sector as $k => $v) : ?>
                                      <option value="<?php echo $v['id'] ?>" <?php if (set_value('sector', isset($consultation_data['sector_id']) ? $consultation_data['sector_id'] : '') == $v['id']) {
                                                                                echo "selected='selected'";
                                                                              } ?>><?php echo $v['name'] ?></option>
                                    <?php endforeach ?>
                                  </select>
                          ...
                          <div class="box-footer">
                            <?php if (in_array('updateConsultation', $user_permission)) : ?>
                              <!-- you must have the permission to update to get the Save button -->
