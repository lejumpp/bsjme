            ...
            <form action="<?php echo base_url('auth/update_password') ?>" method="post">
                ...
                <class="form-group has-feedback">
                    ...
                    <?php if (isset($email_hash, $email_code)) { ?>
                        <input type="hidden" class="form-control" name="email_hash" value="<?php echo $email_hash ?>">
                        <input type="hidden" class="form-control" name="email_code" value="<?php echo $email_code ?>">
                    <?php } ?>
                    ...
                    <div class="form-group has-feedback">
                        ...
                        <input type="password" class="form-control" name="password_conf" id="password_conf" placeholder="Confirm Password">
                    </div>
                    <div class="row">
                        <div class="col-xs-4">
                        ...
                        <div class="col-xs-8">
                            <button type="submit" class="btn btn-success btn-block btn-flat">Update My Password</button>
                        </div> <!-- /.col -->
                    </div>
